...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entrada.fecha_publicacion'
        db.add_column(u'blog_entrada', 'fecha_publicacion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entrada.fecha_publicacion'
        db.delete_column(u'blog_entrada', 'fecha_publicacion')
