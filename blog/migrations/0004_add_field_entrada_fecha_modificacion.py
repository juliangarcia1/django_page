...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entrada.fecha_modificacion'
        db.add_column(u'blog_entrada', 'fecha_modificacion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entrada.fecha_modificacion'
        db.delete_column(u'blog_entrada', 'fecha_modificacion')
    ...
    models = {
        u'blog.entrada': {
            ...
            'fecha_modificacion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
